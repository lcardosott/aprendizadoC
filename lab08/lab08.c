...
int main(){
    ...
    p_mapa raiz_mapa;
    raiz_mapa = calloc(1,sizeof(struct mapa));
    raiz_mapa = NULL;

    p_visita raiz_visita;
    raiz_visita = calloc(1,sizeof(struct visita));
    raiz_visita = NULL;
    ...
    for (int i = 0; i < quantidade; i++) {
        ...
        if (strcmp(operacao, "insere_visita")==0){
            ...
            char *nome_cidade = malloc(100*sizeof(char));
            int *data = malloc(sizeof(int));
            int *pista = malloc(sizeof(int)); 
            scanf("%s %d %d", nome_cidade, data, pista);

            raiz_mapa = insere_visita_mapa(raiz_mapa, nome_cidade);
            raiz_visita = insere_visita_visita(raiz_visita, nome_cidade, data, pista);
            ...
            int* data = malloc(sizeof(int));
            char *nome_remocao = malloc(100*sizeof(char));
            scanf("%d", data);

            raiz_visita = remover_visita(data, raiz_visita, nome_remocao);
            raiz_mapa = remover_mapa(data, raiz_mapa, nome_remocao);
            ...
            relatorio_data(raiz_visita);
        }
        else if(strcmp(operacao, "relatorio_pista") == 0){
            relatorio_pistas(raiz_visita);
        }
    }
//    limpa_mapa(raiz_mapa);
//    limpa_visita(raiz_visita);
    return 0;
}